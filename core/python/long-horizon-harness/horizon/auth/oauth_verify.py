...
_CACHE_MAX_TTL = 300.0  # cap cache entries at 5 min even if the token lives longer
_CACHE_MAX_ENTRIES = 4096  # only valid tokens are cached; bound unbounded growth
