...
try:
    # Distribution name is "lha" (kept as the Cloud Run service / deploy
    # contract); the import package is "horizon". See pyproject [project].name.
    __version__ = _pkg_version("lha")
except PackageNotFoundError:  # editable/source checkout without installed dist metadata
