...
@pytest.mark.asyncio
async def test_drive_child_pauses_then_resumes_without_repeating_side_effect() -> None:
    EFFECTS.clear()
    child = LlmAgent(
    ...
    session = await sessions.create_session(app_name=DELEGATE_APP_NAME, user_id="cu")
