...
def test_list_rows_include_workspace_window(sessions_client: TestClient) -> None:
...
def test_put_window_creates_missing_session(sessions_client: TestClient) -> None:
...
def test_put_window_updates_existing_session(sessions_client: TestClient) -> None:
    resp = sessions_client.put(
