...
def client(monkeypatch):
    ...
    set_secret_store(SecretManagerStore(client=FakeSecretClient(), project_id="proj"))
    app = FastAPI()
...
def test_import_commit_overwrites_on_conflict(client):
    ...
    r = client.post("/lha/secrets/import", json={"content": "FOO=new", "commit": True})
