...
async def test_view_file_happy_path(
    ...
    tool = ViewFileTool()
    result = await tool.run_async(args={"path": "doc.pdf"}, tool_context=fake_ctx)
...
async def test_view_file_missing_file(
    ...
    tool = ViewFileTool()
    result = await tool.run_async(args={"path": "nope.pdf"}, tool_context=fake_ctx)
...
async def test_view_file_mime_from_bytes_not_extension(
    ...
    tool = ViewFileTool()
    result = await tool.run_async(args={"path": "shot.png"}, tool_context=fake_ctx)
