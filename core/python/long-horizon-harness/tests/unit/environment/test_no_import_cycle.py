...
def test_environment_layer_has_no_tools_import():
    import horizon.environment.base as base
    import horizon.environment.local as local
...
def test_old_locations_are_gone():
    for mod in ("horizon.tools.processes.handle", "horizon.tools.processes.registry"):
