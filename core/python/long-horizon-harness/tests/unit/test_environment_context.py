...
def test_active_environment_raises_when_unset() -> None:
    from horizon.environment_context import active_environment, clear_active_environment
...
def test_active_environment_is_isolated_across_async_tasks(tmp_path: Path) -> None:
