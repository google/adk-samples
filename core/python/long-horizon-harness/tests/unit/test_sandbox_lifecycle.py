    ...
    *,
    ...
    def fake_snapshot_create(
        *, source_sandbox_environment_name: str, config: Any = None
        ...
        snap_obj = SimpleNamespace(name=snap_resource, display_name=display_name)
...
class TestEnsureTemplate:
    def test_creates_when_missing(self) -> None:
        ...
        assert (
            create_call["display_name"] == DEFAULT_TEMPLATE_DISPLAY_NAME + "-hermetic"
        )
        ...
        assert _config_get(config, "default_container_environment") in (None, {})
        assert (
            _config_get(_config_get(config, "egress_control_config"), "internet_access")
            is False
        )
...
class TestDeleteSandbox:
    ...
    def test_swallows_404(self) -> None:
        ...
        # Must not raise.
        delete_sandbox(client, sandbox_name="projects/.../sandboxEnvironments/gone")
    ...
    def test_propagates_non_404_errors(self) -> None:
        ...
        with pytest.raises(RuntimeError):
            delete_sandbox(client, sandbox_name="projects/.../sandboxEnvironments/x")
...
class TestRuntimeImageVersion:
    ...
    def test_ignores_registry_host_port(self) -> None:
        ...
        assert runtime_image_version("localhost:5000/runtime:v1.2.3") == "v1_2_3"
...
class TestSandboxDisplayName:
    ...
    def test_empty_user_id_falls_back_to_anonymous(self) -> None:
        ...
        assert sandbox_display_name("", RUNTIME_IMAGE) == "lha-anonymous-v0_11_0"
    ...
    def test_version_scopes_identity(self) -> None:
        ...
        assert sandbox_display_name("alice", RUNTIME_IMAGE) != sandbox_display_name(
            "alice", RUNTIME_IMAGE_OLD
        )
...
class TestFindUserSandbox:
    def test_returns_running_sandbox_matching_display_name(self) -> None:
        from horizon.sandbox.lifecycle import find_user_sandbox, sandbox_display_name
        ...
        assert calls["sandbox_list"] == [{"name": agent_instance, "config": None}]
...
class TestSnapshotUserSandbox:
    def test_creates_snapshot_and_returns_name(self) -> None:
        ...
        assert _config_get(call["config"], "display_name") == "lha-alice-v0_11_0-snap"
...
class TestDeleteSnapshot:
    def test_calls_delete(self) -> None:
        ...
        client, calls = _fake_client()
        snap = (
            "projects/p/locations/l/reasoningEngines/r/sandboxEnvironmentSnapshots/s1"
        )
