...
class TestListAction:
    ...
    async def test_list_partitions_by_state(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
...
class TestPollAction:
    async def test_poll_running_returns_status(
        ...
        result = await process(action="poll", session_id=h.session_id, tool_context=ctx)
    ...
    async def test_poll_unknown_session_returns_error(self, context_factory) -> None:
        from horizon.tools.processes.process import process
...
class TestWaitAction:
    async def test_wait_returns_exit_code(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
...
class TestKillAction:
    async def test_kill_stops_process(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process

        ctx = context_factory()
        h = spawn_into(ctx, "sleep 30")
        await asyncio.sleep(0.2)
        result = await process(action="kill", session_id=h.session_id, tool_context=ctx)
...
class TestWriteAction:
    async def test_write_drives_interactive(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
    ...
    async def test_write_to_unknown_session_errors(self, context_factory) -> None:
        from horizon.tools.processes.process import process
...
class TestWaitForAction:
    async def test_matches_pattern_in_output(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
    ...
    async def test_times_out_while_running(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
    ...
    async def test_missing_pattern_rejected(self, context_factory, spawn_into) -> None:
        from horizon.tools.processes.process import process
