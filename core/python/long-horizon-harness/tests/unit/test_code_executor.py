...
_FAKE_ENGINE_RESOURCE = "projects/fake/locations/us-central1/reasoningEngines/123"
_FAKE_SANDBOX_RESOURCE = (
    "projects/fake/locations/us-central1/reasoningEngines/123/sandboxEnvironments/456"
)
...
def test_code_executor_is_never_unsafe_local_executor(
    ...
    monkeypatch.delenv("CODE_SANDBOX_RESOURCE_NAME", raising=False)
    app_agent = _reload_app_agent()
    assert not isinstance(app_agent.root_agent.code_executor, UnsafeLocalCodeExecutor)
