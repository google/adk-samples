...
class TestEcosystemDetection:
    ...
    async def test_detects_python_from_requirements(self, tmp_path: Path) -> None:
        from horizon.tools.repo_overview import repo_overview
    ...
    async def test_detects_node_and_package_manager(self, tmp_path: Path) -> None:
        from horizon.tools.repo_overview import repo_overview
...
class TestEntrypoints:
    ...
    async def test_parses_package_json_main_and_bin(self, tmp_path: Path) -> None:
        from horizon.tools.repo_overview import repo_overview
    ...
    async def test_no_entrypoints_is_empty_list_not_error(self, tmp_path: Path) -> None:
        from horizon.tools.repo_overview import repo_overview
...
class TestStructureTree:
    ...
    async def test_tree_is_capped_and_flags_truncated(self, tmp_path: Path) -> None:
...
class TestModuleSurface:
    ...
    def test_registered_on_root_agent(self) -> None:
        ...
        names = {
            getattr(t, "__name__", getattr(t, "name", "")) for t in root_agent.tools
        }
