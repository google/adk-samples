...
from horizon.fast_api_app import _resolve_service_uris, resolve_session_service_uri
...
def test_returns_session_db_url_for_postgres(
    ...
    assert resolve_session_service_uri() == "postgresql://user:pass@host:5432/db"
