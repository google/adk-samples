...
class TestRecordToolCall:
    def test_increments_tool_calls_this_iteration(self) -> None:
        ...
        budget = IterationBudget(max_iterations=5, max_tool_calls_per_iteration=4)
        budget.record_iteration()
        budget.record_tool_call()
    ...
    def test_raises_when_per_iter_cap_hit(self) -> None:
        ...
        budget = IterationBudget(max_iterations=5, max_tool_calls_per_iteration=3)
        budget.record_iteration()
        budget.record_tool_call()
        budget.record_tool_call()
        budget.record_tool_call()
    ...
    def test_tool_call_counter_does_not_advance_past_cap(self) -> None:
        ...
        budget = IterationBudget(max_iterations=5, max_tool_calls_per_iteration=2)
        budget.record_iteration()
        budget.record_tool_call()
        budget.record_tool_call()
        for _ in range(5):
...
class TestHalt:
    def test_halt_sets_flag_and_reason(self) -> None:
        ...
        assert budget.halt_reason == "guardrail triggered: repeated_tool_failure"
...
class TestLoopScenario:
    def test_three_iterations_with_tool_calls_each(self) -> None:
        ...
        budget = IterationBudget(max_iterations=3, max_tool_calls_per_iteration=4)
