...
import type { State } from "@google/adk/dist/types/sessions/state";
 ...
 * * TYPE: Returns Promise<unknown> to satisfy 'LlmResponse | undefined' requirement.
 */
...
export function beforeTool({
  ...
  const lowercasedArgs = lowercaseValue(args) as Record<string, unknown>;
