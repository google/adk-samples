...
2.  **Update Metadata**: Open `on_brand_genmedia/data/brand_assets_metadata.json` and add an entry for the new asset. Below is a suggested example based on the existing file. Please feel free to come up with your own schema and fields based on your needs.
