...
Run the following command from the root of the repository. Ensure the `GOOGLE_CLOUD_PROJECT` environment variable is still set in your current shell session (as configured in Prerequisites).
