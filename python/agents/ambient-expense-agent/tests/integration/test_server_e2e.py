...
def start_server() -> subprocess.Popen[str]:
    ...
    command = [
        ...
        "-m",
        "uvicorn",
        "ambient_expense_agent.fast_api_app:app",
        "--host",
        "0.0.0.0",
        "--port",
        "8000",
...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    session_url = f"{BASE_URL}/apps/ambient_expense_agent/users/{user_id}/sessions"
    ...
    data = {
        ...
        "new_message": {
            ...
            "parts": [
                {
                    "text": '{"data": {"amount": 50.0, "submitter": "user@example.com", "category": "meals", "description": "Lunch", "date": "2026-06-04"}}'
                }
            ],
        },
        "streaming": True,
    ...
    for event in events:
        ...
        if output is not None and output.get("status") == "approved":
