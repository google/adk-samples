...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    from high_volume_document_analyzer.agent import app as adk_app
...
app.title = "high-volume-document-analyzer"
app.description = (
    "API for interacting with the Agent high-volume-document-analyzer"
)
